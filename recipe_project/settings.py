...
SECRET_KEY = 'django-insecure-_^iy$77edg)6b(@xha!#lim=9_qji(%2$nym(v^5c#1qhz7$1&'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'recipes',  # Custom app for recipes
]
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Start permissive for learning
    ],
